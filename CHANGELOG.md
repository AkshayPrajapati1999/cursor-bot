...
- Updated daily report schedule to **7:10 PM IST (GMT+05:30)**, Monday–Friday (scheduled as `40 13 * * 1-5` UTC since GitHub Actions cron triggers run strictly on UTC).
